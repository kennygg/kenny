        ...
        <div class="col-md-6">
          <div class="tile">
            ...
            <div class="embed-responsive embed-responsive-16by9">
              <canvas class="embed-responsive-item" id="lineChartDemo" width="752" height="423" style="width: 752px; height: 423px;"></canvas>
            </div>
          </div>
        </div>
        <div class="col-md-6">
          <div class="tile">
            ...
            <div class="embed-responsive embed-responsive-16by9">
              <canvas class="embed-responsive-item" id="pieChartDemo" width="752" height="423" style="width: 752px; height: 423px;"></canvas>
            </div>
          </div>
        </div>
      </div>
